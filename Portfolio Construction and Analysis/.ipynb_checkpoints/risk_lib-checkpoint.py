...
def get_ffme_returns(data : str):
    """
    Load the Fama-French Dataset for the returns of the Top and Bottom Deciles by MarketCap
    """
    me_m = pd.read_csv(data, header=0, index_col=0, na_values=-99.99)
...
def get_hfi_returns(data : str):
    """
    Load and format the EDHEC Hedge Fund Index Returns
    """
    hfi = pd.read_csv(data, header=0, index_col=0, parse_dates=True)
    hfi = hfi/100
